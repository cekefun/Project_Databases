...
function deleteSensor(element) {
	var result = window.confirm("Are you sure you want to delete the sensor?") //TRANSLATE
	if (result == false) {
		return;
	}
	$.ajax({
...
function DisplaySensorDataTable(dataobject) {
	...
	for (i = 0; i < dataobject.sensors.length; i++) {
		...
		tableelement_apparature.setAttribute("id","Apparature"); //TRANSLATE
		...
		tableelement_title.setAttribute("id", "Title"); //TRANSLATE
		...
		tableelement_description.setAttribute("id", "Description"); //TRANSLATE
		...
		tableelement_unit.setAttribute("id", "Unit"); //TRANSLATE
		...
		tableelement_active.setAttribute("id", "Active"); //TRANSLATE
